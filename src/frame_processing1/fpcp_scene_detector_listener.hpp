...
#ifndef SRC_FRAME_PROCESSING1_FPCP_SCENE_DETECTOR_LISTENER_HPP_
#define SRC_FRAME_PROCESSING1_FPCP_SCENE_DETECTOR_LISTENER_HPP_
...
#endif /* SRC_FRAME_PROCESSING1_FPCP_SCENE_DETECTOR_LISTENER_HPP_ */
