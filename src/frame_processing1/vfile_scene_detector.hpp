...
#ifndef SRC_FRAME_PROCESSING1_VFILE_SCENE_DETECTOR_HPP_
#define SRC_FRAME_PROCESSING1_VFILE_SCENE_DETECTOR_HPP_
...
#endif /* SRC_FRAME_PROCESSING1_VFILE_SCENE_DETECTOR_HPP_ */
