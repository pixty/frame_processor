...
#ifndef SRC_FRAME_PROCESSING1_SHOW_STREAM_DETECTOR_HPP_
#define SRC_FRAME_PROCESSING1_SHOW_STREAM_DETECTOR_HPP_
...
#endif /* SRC_FRAME_PROCESSING1_SHOW_STREAM_DETECTOR_HPP_ */
